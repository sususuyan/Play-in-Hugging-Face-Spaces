...
training_args = SFTConfig(
    output_dir="./qwen2.5-1.5b-alpaca-cleaned-q4",
    ...
    push_to_hub=True,
    hub_model_id="rookiezyp/Qwen2.5-1.5B-alpaca-cleaned-q4-20260320",
)
...
trainer.save_model("./qwen2.5-1.5b-alpaca-cleaned-q4-20260320")
